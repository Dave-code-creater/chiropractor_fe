        ...
        <div className="">
          ...
          <div className="grid grid-cols-12 mb-11">
            ...
            <div className="col-span-8 max-xl:mt-6 xl:col-span-8 xl:pl-8 w-full min-h-[230px]">
              <div className="grid grid-cols-8 h-full px-8 max-lg:py-8 rounded-3xl bg-gray-100 w-full max-xl:max-w-3xl max-xl:mx-auto">
                <div className="col-span-4 md:col-span-4 flex items-center">
                  <div className="flex flex-col sm:flex-row items-center sm:justify-center w-full">
                    <div className="sm:px-4 sm:border-r border-gray-200 flex items-center justify-center flex-col">
          ...
          <div className="pb-8 border-b border-gray-200 max-xl:max-w-3xl max-xl:mx-auto">
            ...
            <p className="font-normal text-lg leading-8 text-gray-500 ">
              Dr. Phan is an excellent chiropractor. He takes his time to treat
              his patients. He has a lot of attention to details when working
              with his patients. I highly recommend anyone with an auto accident
              to come give him a shot.
            </p>
            <div className="flex sm:items-center flex-col sm:flex-row justify-between  mb-4">
              <div className="flex items-center gap-3">
                <svg
            ...
            <p className="font-normal text-lg leading-8 text-gray-500 "></p>
            <div className="flex sm:items-center flex-col sm:flex-row justify-between  mb-4">
              <div className="flex items-center gap-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
