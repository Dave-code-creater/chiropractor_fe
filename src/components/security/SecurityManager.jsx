...
const SecurityManager = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'failed': case 'blocked': return 'destructive';
      ...
      <Card>
        <CardContent className="p-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <div className="text-2xl font-bold">{accessAttempts.filter(a => a.status === 'success').length}</div>
      ...
      <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => updateSecuritySetting('passwordComplexity', value)}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => updateSecuritySetting('loginAttempts', parseInt(value))}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Track user devices and locations</p>
                </div>
                <Switch
                  checked={securitySettings.deviceTracking}
                  onCheckedChange={(checked) => updateSecuritySetting('deviceTracking', checked)}
                />
              </div>
        ...
        <div className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Your system is configured to meet HIPAA requirements. All patient data is encrypted, 
              access is logged, and audit trails are maintained.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-3 border border-green-200 bg-green-50 rounded-lg">
              ...
              <p className="text-xs text-green-600 mt-1">AES-256 encryption enabled</p>
            </div>
            ...
            <div className="p-3 border border-green-200 bg-green-50 rounded-lg">
              ...
              <p className="text-xs text-green-600 mt-1">Role-based access implemented</p>
            </div>
            ...
            <div className="p-3 border border-green-200 bg-green-50 rounded-lg">
              ...
              <p className="text-xs text-green-600 mt-1">Complete activity logging</p>
            </div>
          </div>
        </div>
      </CardContent>
  ...
  const ThreatMonitoring = () => (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Active security threats and suspicious activities</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {sampleData.threats.map(threat => (
            <div key={threat.id} className="p-4 border border-red-200 bg-red-50 rounded-lg">
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  <Button size="sm" variant="outline" onClick={() => handleThreatAction(threat.id, 'investigate')}>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        {attempt.ipAddress} • {attempt.location} • {attempt.device}
                      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Monitor system security, manage access controls, and ensure HIPAA compliance</p>
        </div>
        <div className="flex items-center space-x-2">
        ...
        <TabsContent value="compliance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Monitor and maintain HIPAA compliance requirements</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <Card>
                  <CardContent className="p-4">
                    <div className="flex items-center space-x-2">
                      <Shield className="h-5 w-5 text-green-600" />
                      <div>
                        <div className="text-lg font-bold text-green-600">Secured</div>
                        <div className="text-sm text-gray-600">PHI Protection</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Alert>
                ...
                <AlertDescription>
                  Your system meets all HIPAA requirements for protecting patient health information (PHI). 
                  Regular compliance audits are performed automatically.
                </AlertDescription>
              </Alert>
