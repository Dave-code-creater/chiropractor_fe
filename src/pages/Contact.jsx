                    ...
                    <div class="lg:mb-0 mb-10">
                        <div class="group w-full h-full">
                            <div class="relative h-full">
                                <img src={callCenter} alt="Contact Us sections" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover" />
                                ...
                                <div class="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div class="bg-white rounded-lg p-6 block">
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            ...
                                            <a class="text-black text-base font-normal leading-6 ml-5" href="tel:3037770125">Call Us: 303-777-0125</a>
                                        </a>
                                        <a href="javascript:;" class="flex items-center mb-6">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a class="text-black text-base font-normal leading-6 ml-5 hover:underline" href="mailto:drdieuphanchiropractor@gmail.com">
                                        ...
                                        <a href="javascript:;" class="flex items-center">
                                            ...
                                            <a class="text-black text-base font-normal leading-6 ml-5 hover:underline" href="https://www.google.com/maps/search/?api=1&query=1385+West+Alameda+Ave,+Denver,+CO+80223" target="_blank" rel="noopener noreferrer">
