                    ...
                    <div className="lg:mb-0 mb-10">
                        <div className="group w-full h-full">
                            <div className="relative h-full">
                                <img src={callCenter} alt="Contact Us sections" className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700 object-cover" />
                                ...
                                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div className="bg-white rounded-lg p-6 block">
                                        <a href="javascript:;" className="flex items-center mb-6">
                                            ...
                                            <a className="text-foreground text-base font-normal leading-6 ml-5" href="tel:3037770125">Call Us: 303-777-0125</a>
                                        </a>
                                        <a href="javascript:;" className="flex items-center mb-6">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <a className="text-foreground text-base font-normal leading-6 ml-5 hover:underline" href="mailto:drdieuphanchiropractor@gmail.com">
                                                drdieuphanchiropractor@gmail.com
                                            </a>
                                        </a>
                                        <a href="javascript:;" className="flex items-center">
                                            ...
                                            <a className="text-foreground text-base font-normal leading-6 ml-5 hover:underline" href="https://www.google.com/maps/search/?api=1&query=1385+West+Alameda+Ave,+Denver,+CO+80223" target="_blank" rel="noopener noreferrer">
