  ...
  const demoSteps = [
    {
      ...
      content:
        "This demonstrates how the interactive tutorial system works throughout the application.",
      target: ".demo-header",
      action: "look",
    ...
    },
    {
      ...
      content:
        "The tutorial system supports multiple display variants: buttons, cards, inline helpers, and floating action buttons.",
    ...
    },
    {
      ...
      content:
        "Important features can be highlighted with interactive overlays that guide users through complex workflows.",
    ...
    },
    {
      ...
      content:
        "Users can control the pace of tutorials with play/pause controls and step through content at their own speed.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Standard button for toolbars and headers
                </p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Contextual help within content areas
                </p>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-600">
                  Always-available help (see bottom-right corner)
                </p>
            ...
            <Alert className="border-blue-200 bg-blue-50">
              ...
              <AlertDescription>
                <ul className="mt-2 space-y-1 text-sm">
                  <li>
                    • <strong>Auto-advance:</strong> Tutorials can automatically
                    progress through steps
                  </li>
                  <li>
                    • <strong>Speed control:</strong> Users can adjust tutorial
                    playback speed
                  </li>
                  <li>
                    • <strong>Progress tracking:</strong> System remembers
                    completed tutorials
                  </li>
                  <li>
                    • <strong>Contextual help:</strong> Feature-specific
                    guidance available throughout the app
                  </li>
                  <li>
                    • <strong>Interactive elements:</strong> Click, highlight,
                    and demonstrate features in real-time
                  </li>
                </ul>
              </AlertDescription>
            </Alert>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-gray-600">
                  Our interactive tutorial system provides comprehensive
                  onboarding and feature education for the chiropractic practice
                  management platform. It includes:
                </p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3"></div>
                    <span>
                      <strong>8 comprehensive tutorials</strong> covering all
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Multiple display variants</strong> for different
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Interactive highlighting</strong> that overlays on
                      actual UI elements
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Progress tracking</strong> and completion badges
                      for user motivation
                    </span>
                  </li>
                </ul>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      Inline tutorial launcher in header
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">Patient Management</h4>
                    <p className="text-sm text-gray-600">
                      Feature-specific help buttons
                    </p>
                  </div>
                  <div className="p-4 border rounded-lg">
