...
import { Shield, Lock, Eye, Database, UserCheck, AlertTriangle, FileText, Users, Mail, Clock } from "lucide-react"
    ...
    const sections = [
            ...
            sharing: [
                {
                    ...
                    description: "With your healthcare providers for treatment, care coordination, and medical consultations",
                    conditions: "Only relevant medical information shared with authorized providers"
                },
                {
                    category: "Insurance Companies",
                    description: "For claims processing, coverage verification, and payment authorization",
                    conditions: "Limited to information necessary for insurance purposes"
                },
                {
                    category: "Legal Requirements",
                    description: "When required by law, court order, or regulatory authority",
                    conditions: "Only the minimum information required by law"
                },
                {
                    category: "Emergency Situations",
                    description: "To protect your health and safety in emergency situations",
                    conditions: "Limited to information necessary for immediate care"
                },
                {
                    category: "Business Associates",
                    description: "With vendors who help operate our platform (hosting, payment processing, etc.)",
                    conditions: "All vendors sign Business Associate Agreements ensuring HIPAA compliance"
                }
            ]
        },
        {
        ...
        },
        {
            ...
            rights: [
                {
                    right: "Access",
                    description: "Request copies of your medical records and account information",
                ...
                {
                    right: "Accounting",
                    description: "Receive a list of disclosures we've made of your information",
            ...
            retention: [
                {
                    ...
                    period: "Minimum 7 years from last treatment date (longer if required by state law)",
            ...
            cookies: [
                {
                    ...
                    purpose: "Required for platform functionality, security, and user authentication",
                    control: "Cannot be disabled as they are necessary for platform operation"
                },
                {
                    type: "Performance Cookies",
                    purpose: "Help us understand how users interact with our platform to improve performance",
                    control: "Can be disabled through browser settings or cookie preferences"
                },
                {
                    type: "Security Cookies",
                    purpose: "Detect suspicious activity and protect against security threats",
        ...
        },
        {
            ...
            contact: {
                ...
                address: "ChiroCare Privacy Department, 123 Healthcare Blvd, Medical City, MC 12345",
            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-3">
                                    <h2 className="text-xl font-semibold">HIPAA Privacy Notice</h2>
                                    <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                                        Protected Health Information
                                    </Badge>
                                </div>
                                <p className="text-muted-foreground leading-relaxed">
                                    This Privacy Policy serves as our HIPAA Notice of Privacy Practices. It describes how 
                                    we may use and disclose your Protected Health Information (PHI) and your rights regarding 
                                    this information. We are required by law to maintain the privacy of your PHI and to provide 
                ...
                <div className="space-y-6">
                    {sections.map((section, index) => (
                        <Card key={section.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-200">
                            <CardContent className="p-6">
                                            ...
                                            <div className="space-y-4 mt-4">
                                                {section.categories.map((category, i) => (
                                                    <div key={i} className="border-l-2 border-gray-200 pl-4">
                                                        <h3 className="font-semibold text-sm mb-2">{category.type}</h3>
                                            ...
                                            <div className="space-y-4 mt-4">
                                                {section.purposes.map((purpose, i) => (
                                                    <div key={i} className="border-l-2 border-green-200 pl-4">
                                                        <h3 className="font-semibold text-sm mb-2">{purpose.category}</h3>
                                                        <ul className="space-y-1">
                                            ...
                                            <div className="space-y-4 mt-4">
                                                {section.sharing.map((share, i) => (
                                                    <div key={i} className="border rounded-lg p-3 bg-gray-50 dark:bg-gray-800">
                                                        <h3 className="font-semibold text-sm mb-1">{share.category}</h3>
                                                        <p className="text-sm text-muted-foreground mb-2">{share.description}</p>
                                                        <p className="text-xs text-muted-foreground italic">{share.conditions}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
                                            ...
                                            <div className="space-y-4 mt-4">
                                                {section.security.map((sec, i) => (
                                                    <div key={i} className="border-l-2 border-orange-200 pl-4">
                                                        <h3 className="font-semibold text-sm mb-2">{sec.category}</h3>
                                                        <ul className="space-y-1">
                                        ...
                                        {section.rights && (
                                            <div className="space-y-3 mt-4">
                                                {section.rights.map((right, i) => (
                                                    <div key={i} className="border rounded-lg p-3 bg-blue-50 dark:bg-blue-900/20">
                                                        <div className="flex items-center gap-2 mb-1">
                                                            <h3 className="font-semibold text-sm">Right to {right.right}</h3>
                                                        </div>
                                                        <p className="text-sm text-muted-foreground mb-2">{right.description}</p>
                                                        <p className="text-xs text-muted-foreground italic">How to exercise: {right.how}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
                                        ...
                                        {section.retention && (
                                            <div className="space-y-3 mt-4">
                                                {section.retention.map((ret, i) => (
                                                    <div key={i} className="border rounded-lg p-3 bg-purple-50 dark:bg-purple-900/20">
                                                        <h3 className="font-semibold text-sm mb-1">{ret.type}</h3>
                                                        <p className="text-sm text-muted-foreground mb-1">Retention Period: {ret.period}</p>
                                                        <p className="text-xs text-muted-foreground italic">Purpose: {ret.purpose}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
                                            ...
                                            <div className="space-y-3 mt-4">
                                                {section.cookies.map((cookie, i) => (
                                                    <div key={i} className="border rounded-lg p-3 bg-yellow-50 dark:bg-yellow-900/20">
                                                        <h3 className="font-semibold text-sm mb-1">{cookie.type}</h3>
                                                        <p className="text-sm text-muted-foreground mb-1">{cookie.purpose}</p>
                                                        <p className="text-xs text-muted-foreground italic">{cookie.control}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
                                            ...
                                            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                    <div className="space-y-3">
                                                        <div>
                                                            <span className="font-medium">{section.contact.privacy.title}:</span>
                                                            <p className="text-muted-foreground">{section.contact.privacy.email}</p>
                                                            <p className="text-muted-foreground">{section.contact.privacy.phone}</p>
                                                        </div>
                                                        <div>
                                                            <span className="font-medium">{section.contact.security.title}:</span>
                                                            <p className="text-muted-foreground">{section.contact.security.email}</p>
                                                            <p className="text-muted-foreground">{section.contact.security.phone}</p>
                                                        </div>
                                                    </div>
                                                    <div className="space-y-3">
                                                        <div>
                                                            <span className="font-medium">{section.contact.general.title}:</span>
                                                            <p className="text-muted-foreground">{section.contact.general.email}</p>
                                                            <p className="text-muted-foreground">{section.contact.general.phone}</p>
                                                        </div>
                                                        <div>
                                                            <span className="font-medium">Business Hours:</span>
                                                            <p className="text-muted-foreground">{section.contact.hours}</p>
                                                        </div>
                                                    </div>
                    ...
                    <Card className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 border-blue-200">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-center gap-2 mb-3">
                                ...
                                <span className="font-medium">Your Privacy is Our Commitment</span>
                            </div>
                            <p className="text-sm text-muted-foreground mb-4">
                                ChiroCare is dedicated to maintaining the highest standards of privacy and security 
                                for your healthcare information. We continuously update our practices to ensure 
                                compliance with evolving healthcare privacy regulations.
                            </p>
