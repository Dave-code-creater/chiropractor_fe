...
import { Calendar, Shield, AlertTriangle, Scale, FileText, Users } from "lucide-react"
...
export default function TermOfService() {
    ...
    const sections = [
        ...
        },
        {
            ...
            content: null,
            definitions: [
                { term: "Platform", definition: "ChiroCare web application and all associated services" },
                { term: "User", definition: "Any individual who accesses or uses our Platform" },
                { term: "Patient", definition: "A User who seeks or receives healthcare services through our Platform" },
                { term: "Healthcare Provider", definition: "Licensed medical professionals who provide services through our Platform" },
                { term: "Personal Health Information (PHI)", definition: "Any information about health status, provision of healthcare, or payment for healthcare that can be linked to an individual" },
                { term: "Services", definition: "All features, tools, and functionalities provided by ChiroCare" },
                { term: "Account", definition: "Your registered user profile on the Platform" }
            ]
        },
        {
            id: "eligibility",
        ...
        },
        {
            ...
            contact: {
                ...
                address: "ChiroCare Legal Department, 123 Healthcare Blvd, Medical City, MC 12345",
                ...
                <Card className="mb-8 border-l-4 border-l-blue-500">
                    <CardContent className="p-6">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-semibold mb-3">Welcome to ChiroCare</h2>
                                <p className="text-muted-foreground leading-relaxed">
                                    These Terms of Service ("Terms") govern your access to and use of ChiroCare, 
                                    a comprehensive healthcare management platform. By using our services, you agree 
                                    to comply with these terms. Please read them carefully before using our platform.
                                </p>
                            </div>
                        </div>
                    </CardContent>
                                            ...
                                            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                                    <div>
                                                        ...
                                                        <p className="text-muted-foreground">{section.contact.email}</p>
                                                    </div>
                                                    <div>
                                                        <span className="font-medium">Phone:</span>
                                                        <p className="text-muted-foreground">{section.contact.phone}</p>
                                                    </div>
                    ...
                    <Card className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 border-blue-200">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-center gap-2 mb-3">
                                ...
                                <span className="font-medium">Your Healthcare, Our Priority</span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                                ChiroCare is committed to providing secure, reliable, and compliant healthcare management services. 
