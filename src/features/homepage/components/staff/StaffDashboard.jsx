                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <Card className="hover:shadow-md transition-shadow cursor-pointer">
                        <CardContent className="p-4 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">Patient Communication</p>
                        </CardContent>
                    </Card>
                </div>
                            ...
                            <CardContent>
                                {isLoading ? (
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-muted-foreground">A quiet day at the clinic</p>
                                    </div>
                                )}
                            </CardContent>
                        </Card>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between p-4 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium">Call Mrs. Johnson for follow-up</h4>
                                                <p className="text-sm text-muted-foreground">Post-treatment check-in</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            <div className="w-4 h-4 border-2 border-primary rounded"></div>
                                            <div>
                                                <h4 className="font-medium">Insurance verification for John Doe</h4>
                                                <p className="text-sm text-muted-foreground">Verify coverage before appointment</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 border rounded-lg">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-muted-foreground">Schedule equipment maintenance</h4>
                                                <p className="text-sm text-muted-foreground">Monthly maintenance completed</p>
                                            </div>
                                        </div>
