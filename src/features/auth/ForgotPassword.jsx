...
import { setEmailError, clearEmailError } from "../../state/forms/loginFormSlice";
...
export default function ForgotPassword() {
    ...
    const [forgotPasswordMutation, { isLoading, error: forgotPasswordError }] = useForgotPasswordMutation();
                    ...
                    <Card className="border-green-200 bg-green-50">
                        ...
                        <CardContent className="text-center space-y-4">
                            ...
                            <div className="space-y-3 pt-4">
                                ...
                                <Link to="/login">
                                    <Button variant="ghost" className="w-full text-green-700 hover:bg-green-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className={errorEmail ? "border-red-500 focus:border-red-500" : ""}
                                />
                                {errorEmail && (
