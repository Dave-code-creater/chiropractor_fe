...
import { setPasswordError, clearPasswordError, setConfirmPasswordError, clearConfirmPasswordError } from "../../state/forms/registerFormSlice";
...
export default function ResetPassword() {
    ...
    const { data: tokenData, error: tokenError, isLoading: isVerifyingToken } = useVerifyResetTokenQuery(token, {
        skip: !token
    });
    
    const [resetPasswordMutation, { isLoading: isResetting, error: resetError }] = useResetPasswordMutation();
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <Card className="border-red-200 bg-red-50">
                        <CardHeader className="text-center">
                            ...
                            <CardTitle className="text-xl text-red-800">Invalid or Expired Link</CardTitle>
                        </CardHeader>
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    <Card className="border-green-200 bg-green-50">
                        <CardHeader className="text-center">
                            ...
                            <CardTitle className="text-xl text-green-800">Password Reset Successful</CardTitle>
                        </CardHeader>
                        <CardContent className="text-center space-y-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        placeholder="••••••••"
                                        className={pwError ? "border-red-500 focus:border-red-500 pr-10" : "pr-10"}
                                    />
                                    <button
                                        type="button"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        placeholder="••••••••"
                                        className={confirmpwError ? "border-red-500 focus:border-red-500 pr-10" : "pr-10"}
                                    />
                                    <button
                                        type="button"
                                        className="absolute inset-y-0 right-0 pr-3 flex items-center"
                            ...
                            <Button
                                type="submit"
                                disabled={isResetting || !password.trim() || !confirmPassword.trim()}
                                className="w-full"
                            >
                                {isResetting ? (
                                    <>
