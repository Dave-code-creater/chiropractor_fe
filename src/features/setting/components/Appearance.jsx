            ...
            <Card className="max-w-4xl mx-auto">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                        ...
                        { label: "Font Size", options: ["small", "medium", "large"], value: fontSize, setter: handleFontChange },
                        { label: "Color Scheme", options: ["indigo", "green", "red"], value: colorScheme, setter: setColorScheme },
                        { label: "Sidebar Position", options: ["left", "right", "hidden"], value: sidebarPosition, setter: handleSidebarChange },
                        { label: "Button Style", options: ["rounded", "square", "outline"], value: buttonStyle, setter: handleButtonStyleChange },
                ...
                <div className="px-6 pb-6">
                    <Button className="shadcn-button" onClick={() => alert("Appearance settings saved!")}>
                        Save Changes
                    </Button>
                </div>
            </Card>
