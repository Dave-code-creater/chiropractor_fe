...
export default function DateSelector({ bookingData, updateBookingData, selectedDoctor }) {
    ...
    const { data: availabilityData, isLoading: isLoadingAvailability } = useGetDoctorAvailabilityQuery(
        {
    ...
    return (
        <div className="space-y-6">
                        ...
                        {!selectedDate ? (
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Loading {selectedDoctor ? `Dr. ${selectedDoctor.lastName}'s` : ''} availability...
                                </p>
                            </div>
                            ...
                            <div className="text-center py-8 text-muted-foreground">
                                <AlertCircle className="h-12 w-12 mx-auto mb-3 opacity-50" />
                                <p className="text-sm">
                                    No available times for {selectedDoctor ? `Dr. ${selectedDoctor.lastName}` : 'this doctor'} on this date
                                </p>
            ...
            <Card className="bg-blue-50 border-blue-200">
                <CardContent className="p-4">
                    <h4 className="text-sm font-medium text-blue-900 mb-2">Booking Guidelines:</h4>
                    <ul className="text-sm text-blue-800 space-y-1">
                        ...
                        {selectedDoctor && (
                            <li>• Dr. {selectedDoctor.lastName} specializes in {selectedDoctor.specializations?.primary}</li>
                        )}
                    </ul>
                </CardContent>
            </Card>
