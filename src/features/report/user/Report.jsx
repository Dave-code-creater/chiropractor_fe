        ...
        <div className="p-3 sm:p-4 lg:p-6 bg-gradient-to-r from-earthfire-clay-50 to-earthfire-brown-50">
          <div className="max-w-4xl mx-auto">
            <div className="mb-4 sm:mb-6 text-center">
              ...
              <div className="flex items-center justify-center gap-2 text-xs sm:text-sm text-earthfire-brick-700 bg-earthfire-clay-50 border border-earthfire-clay-200 rounded px-3 sm:px-4 py-2 max-w-xs sm:max-w-md mx-auto">
            ...
            >
              <CardHeader className="pb-3 sm:pb-4 p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                  <div className="p-3 sm:p-4 rounded-xl bg-earthfire-clay-100 self-center sm:self-auto">
                    <FileTextIcon className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-earthfire-brick-600" />
                  </div>
                  <div className="flex-1 text-center sm:text-left">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2 sm:mb-1">
                      ...
                      <Badge className="bg-earthfire-clay-100 text-earthfire-brick-800 border-earthfire-clay-200 self-center sm:self-auto">
                        Simple & Easy
                      </Badge>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-3 sm:mt-4">
                      <div className="flex items-center justify-center sm:justify-start gap-2">
                        <Clock className="h-4 w-4 text-earthfire-brick-600 flex-shrink-0" />
                        <span className="text-sm text-earthfire-brick-700 font-medium">5-10 min each form</span>
                      </div>
                      <div className="flex items-center justify-center sm:justify-start gap-2">
                        <User className="h-4 w-4 text-earthfire-brick-600 flex-shrink-0" />
                        <span className="text-sm text-earthfire-brick-700 font-medium">6 optional forms</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="pt-0 pb-4 sm:pb-6 px-4 sm:px-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <Button className="bg-earthfire-brick-600 hover:bg-earthfire-brick-700 w-full sm:w-auto">
                    Get Started →
                  </Button>
                </div>
              </CardContent>
            ...
            <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 max-w-4xl mx-auto">
              <Card className="bg-white/80">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 bg-earthfire-clay-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-earthfire-brick-600 font-bold text-sm">1</span>
                  </div>
              ...
              <Card className="bg-white/80">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 bg-earthfire-brown-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-earthfire-brown-700 font-bold text-sm">2</span>
                  </div>
              ...
              <Card className="bg-white/80">
                <CardContent className="p-3 sm:p-4 text-center">
                  <div className="w-8 h-8 bg-earthfire-umber-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-earthfire-umber-700 font-bold text-sm">3</span>
                  </div>
