    ...
    "pt-001": [
        {
            ...
            objectiveFindings: "ROM: Flexion 80°, Extension 25°, Lateral flexion 30° bilaterally. Palpation reveals decreased muscle tension in lumbar paraspinals.",
            assessment: "Acute lumbar strain showing significant improvement. Patient reports 50% reduction in pain levels.",
            treatment: "Spinal manipulation L3-L5, soft tissue therapy to lumbar paraspinals, therapeutic exercises",
            ...
            status: "completed",
            painLevel: "3/10",
            functionalStatus: "Improved - able to perform daily activities with minimal discomfort"
        },
        {
            id: "note-002",
            date: "2024-01-08",
            type: "Initial Assessment",
            chiefComplaint: "Acute lower back pain following lifting incident at work 2 days ago",
            objectiveFindings: "Antalgic gait, limited lumbar flexion (40°), positive SLR test at 45° on right. Muscle spasm palpable in L3-L5 paraspinals.",
            assessment: "Acute lumbar strain with muscle spasm secondary to improper lifting mechanics. No neurological deficits noted.",
            treatment: "Initial spinal adjustment L4-L5, ice therapy application, patient education on proper lifting techniques",
            ...
            status: "completed",
            painLevel: "7/10",
            functionalStatus: "Significantly limited - difficulty with bending, lifting, prolonged sitting"
        }
    ],
    "pt-002": [
        {
            ...
            date: "2024-01-10",
            type: "Follow-up",
            chiefComplaint: "Persistent neck pain and tension headaches, ongoing for 3 weeks",
            objectiveFindings: "Cervical ROM: Flexion 35°, Extension 40°, Rotation 60° bilaterally. Palpable trigger points in upper trapezius and suboccipital muscles.",
            assessment: "Cervical spine dysfunction with associated tension-type headaches. Forward head posture noted, likely contributing to symptoms.",
            treatment: "Cervical manipulation C2-C4, trigger point therapy to upper trapezius, postural correction exercises demonstrated",
            ...
            status: "completed",
            painLevel: "5/10",
            functionalStatus: "Moderately limited - headaches affecting work concentration"
        }
    ]
};
...
export default function PatientCaseManagement() {
    ...
    const handleAddNote = () => {
        ...
        if (!mockClinicalNotes[selectedPatient.id]) {
            mockClinicalNotes[selectedPatient.id] = [];
        }
        mockClinicalNotes[selectedPatient.id].unshift(note);
    ...
    if (selectedPatient) {
        const patientNotes = mockClinicalNotes[selectedPatient.id] || [];
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <Card>
                            <CardContent className="p-4 text-center">
                                ...
                                <div className="text-2xl font-bold">{selectedPatient.totalVisits}</div>
                        ...
                        <Card>
                            <CardContent className="p-4 text-center">
                                ...
                                <div className="text-sm font-bold">{formatDate(selectedPatient.lastVisit)}</div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div>
                                                <strong>Heart Rate:</strong> {selectedPatient.vitals.heartRate}
                                            </div>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-3">
                                        ...
                                        {selectedPatient.secondaryConditions.length > 0 && (
                                            <div>
                                                <h4 className="font-medium mb-2">Secondary Conditions</h4>
                                                <div className="flex flex-wrap gap-2">
                                                    {selectedPatient.secondaryConditions.map((condition, index) => (
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-2 text-sm">
                                        <div>
                                            <strong>Provider:</strong> {selectedPatient.insurance.provider}
                                        </div>
                                        <div>
                                            <strong>Policy Number:</strong> {selectedPatient.insurance.policyNumber}
                                        </div>
                                        <div>
                                            <strong>Group Number:</strong> {selectedPatient.insurance.groupNumber}
                                        </div>
                                        <div>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="grid grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <Select 
                                                    ...
                                                    onValueChange={(value) => setNewNote({...newNote, duration: value})}
                                                >
                                                    <SelectTrigger>
                                                        <SelectValue />
                                                    </SelectTrigger>
                                            ...
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) => setNewNote({...newNote, painLevel: e.target.value})}
                                                />
                                            </div>
                                        </div>

                                        <div>
                                            <label className="text-sm font-medium">Chief Complaint (Subjective)</label>
                                            <textarea
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onChange={(e) => setNewNote({...newNote, objectiveFindings: e.target.value})}
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                onChange={(e) => setNewNote({...newNote, functionalStatus: e.target.value})}
                                            />
                                        </div>
                                ...
                                <CardContent>
                                    {patientNotes.length > 0 ? (
                                            ...
                                            {patientNotes.map((note) => (
                                                <Card key={note.id} className="border-l-4 border-l-primary">
                                                    <CardContent className="pt-4">
                                                        ...
                                                        <div className="space-y-3 text-sm">
                                                            <div>
                                                                <h4 className="font-medium text-primary mb-1">Subjective (Chief Complaint)</h4>
                                                                <p>{note.chiefComplaint}</p>
                                                            </div>
                                                            {note.objectiveFindings && (
                                                                <div>
                                                                    <h4 className="font-medium text-primary mb-1">Objective Findings</h4>
                                                                    <p>{note.objectiveFindings}</p>
                                                                </div>
                                                            )}
                                                            <div>
                                                                <h4 className="font-medium text-primary mb-1">Assessment</h4>
                                                                <p>{note.assessment}</p>
                                                            </div>
                                                            <div>
                                                                <h4 className="font-medium text-primary mb-1">Treatment</h4>
                                                                <p>{note.treatment}</p>
                                                            </div>
                                                            <div>
                                                                <h4 className="font-medium text-primary mb-1">Plan</h4>
                                                                <p>{note.plan}</p>
                                                            </div>
                                                            {note.functionalStatus && (
                                                                <div>
                                                                    <h4 className="font-medium text-primary mb-1">Functional Status</h4>
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <h3 className="text-lg font-semibold text-muted-foreground">No Clinical Notes</h3>
                                            <p className="text-sm text-muted-foreground mb-4">
                                                Start documenting this patient's treatment by adding your first clinical note.
                                            </p>
                                            <Button 
                                                onClick={() => setIsAddingNote(true)}
                                                variant="outline"
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <Card>
                                    ...
                                    <CardContent className="space-y-3 text-sm">
                                        <div>
                                            <strong>Allergies:</strong> {selectedPatient.medicalHistory.allergies}
                                        </div>
                                        <div>
                                            <strong>Current Medications:</strong> {selectedPatient.medicalHistory.medications}
                                        </div>
                                        <div>
                                            <strong>Previous Surgeries:</strong> {selectedPatient.medicalHistory.previousSurgeries}
                                        </div>
                                        <div>
                                            <strong>Chronic Conditions:</strong> {selectedPatient.medicalHistory.chronicConditions}
                                        </div>
                                        <div>
                                            <strong>Family History:</strong> {selectedPatient.medicalHistory.familyHistory}
                                        </div>
                                    </CardContent>
                                </Card>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 p-6">
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-foreground">Patient Case Management</h1>
                        <p className="text-muted-foreground mt-1">
                                ...
                                <CardContent className="pt-6">
                                    <div className="flex items-start gap-3 mb-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <Badge className={`${getStatusColor(patient.status)} mt-1`}>
                                                {patient.status}
                                            </Badge>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                        ...
                                        {lastNote && (
                                            <div>
                                                <strong>Last Note:</strong> {lastNote.type} ({formatDate(lastNote.date)})
                                            </div>
                                        )}
                                    </div>
